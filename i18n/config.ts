...
export const tMap: Translations = {
  ...
  about_body: {
    ...
    te: "ఆంధ్రప్రదేశ్ రాష్ట్రం, ప్రకాశం జిల్లా, మల్లవరం గ్రామంలో ఉన్న శ్రీ మల్లవరం వెంకటేశ్వర అన్నదాన సమాజము మరియు బ్రాహ్మణ సత్రం పేద బ్రాహ్మణ కుటుంబాలకు ప్రతిరోజు అన్నదానం, ఆధ్యాత్మిక సేవలు మరియు సమాజ సేవ ద్వారా అండగా నిలిచే దాతృత్వ సంస్థ."
  },
  annadanam_title: {
